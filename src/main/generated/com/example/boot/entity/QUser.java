...
public class QUser extends EntityPathBase<User> {
    ...
    private static final long serialVersionUID = 867347947L;
    ...
    public final DatePath<java.time.LocalDate> lastLogin = createDate("lastLogin", java.time.LocalDate.class);
